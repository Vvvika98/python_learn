...
def count_vowels(string):
    VOWELS = "aeiouAEIOU" #в пайтон все регистрозависимое, поэтому А и а - это разные буквы
...
def custom_greeting(*, name: str, greeting: str = "Hello") -> str: #greeting - дефолтный аргумент 
    return f"{greeting} , {name}"

print(custom_greeting(name="John", greeting="Good morning"))
print(custom_greeting(name="John")) #т.к. мы передали дефолтный аргумент, его можно не писать
